import { db, collection, getDocs, doc, addDoc, updateDoc, deleteDoc, setDoc, getDoc, secondaryAuth, createUserWithEmailAndPassword, updatePassword, signInWithEmailAndPassword, query, where, writeBatch } from '../core/firebase-setup.js';
